# Date
  ...
  Date::DATE_FORMATS[:nextsteps] = lambda { |time| time.strftime("%B  #{time.day.ordinalize}") }  # November 3rd
...
# DateTime
  ...
  DateTime::DATE_FORMATS[:pretty] = "%B %e, %Y @%l:%M %P"          # November 3, 3013 @7:00pm
  DateTime::DATE_FORMATS[:podcast] = "%B %e, %Y"
